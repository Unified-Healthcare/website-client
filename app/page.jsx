  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">User Profile</h3>
              <p className="text-gray-500 dark:text-gray-400">View detailed information about the patients and their medical history</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Dynamic QR Code Generation</h3>
              <p className="text-gray-500 dark:text-gray-400">Generate a unique QR code for each user dynamically, allowing easy access to their profile or specific information.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">User Updates</h3>
              <p className="text-gray-500 dark:text-gray-400">Track and view updates made by the user, such as profile changes or new information added.</p>
          </div>
